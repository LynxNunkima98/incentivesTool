...
/* harmony import */ var _guards_auto_login_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./guards/auto-login.guard */ "./src/app/guards/auto-login.guard.ts");
...
const routes = [
    {
        ...
        canLoad: [_guards_auto_login_guard__WEBPACK_IMPORTED_MODULE_3__["AutoLoginGuard"]]
    },
    {
        path: 'tabs',
...
let AuthGuard = class AuthGuard {
    ...
    canLoad() {
        return this.authService.isAuthenticated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(val => val !== null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(isAuthenticated => {
...
let AutoLoginGuard = class AutoLoginGuard {
    ...
    canLoad() {
        return this.authService.isAuthenticated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(val => val !== null), // Filter out initial Behaviour subject value
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), // Otherwise the Observable doesn't complete!
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(isAuthenticated => {
            if (isAuthenticated) {
...
let AuthenticationService = class AuthenticationService {
    constructor(http) {
        this.http = http;
        this.isAuthenticated = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](null);
        this.token = '';
        this.loadToken();
    }
    loadToken() {
    ...
    login(credentials) {
        return this.http.post(`https://reqres.in/api/login`, credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => data.token), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(token => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(Storage.set({ key: TOKEN_KEY, value: token }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => {
            this.isAuthenticated.next(true);
        }));
    }
    logout() {
...
module.exports = __webpack_require__(/*! C:\Users\Lynx\IONIC\Incentives Tool\src\main.ts */"./src/main.ts");
